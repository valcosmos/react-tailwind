  ...
  return (
    <div className="bg-black md:w-4/5 mx-auto relative overflow-hidden">
      <div className="w-full py-16 px-12">
        ...
        <p className="text-lg text-white mt-2 mb-6">这是增强信息</p>
        <div className="flex flex-col md:flex-row items-start gap-4">
          <input
            type="text"
            name=""
            id=""
            className="bg-zinc-800 py-3 px-4 border border-zinc-700 outline-none text-white"
        ...
        <p className="text-sm text-zinc-400 mt-3">7天main飞试用，无需支付</p>
      </div>
