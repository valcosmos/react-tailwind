...
const HowItWorks = () => {
  return (
    <div>
      <SectionHeading
        title="工作流程"
        subTitle="工作流程工作流程工作流程工作流程工作流程工作流程工作流程工作流程工作流程工作流程工作流程工作流程工作流程"
      />

      <div className="mt-14 grid grid-cols-2 md:grid-cols-3 gap-6">
        {[1, 2, 3, 4, 5, 6].map((v) => (
          <div key={v} className="grid justify-items-start gap-y-2">
            <svg
              width="56"
              height="56"
              viewBox="0 0 56 56"
            ...
            <p className="text-gray-500">
              初步沟通初步沟通初步沟通初步沟通初步沟通 初步沟通 初步沟通
              初步沟通 初步沟通 初步沟通 初步沟通 初步沟通 初步沟通 初步沟通
              初步沟通
            </p>
          </div>
        ))}
