...
const Solutions = () => {
  return (
    <div>
      <SectionHeading
        title="解决方案"
        subTitle="解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案"
      />

      <div className="grid lg:grid-cols-2 t-20 gap-20">
        <div>
          <h3 className="mt-7 text-[32px] font-bold">强有力的工具</h3>
          <p className="mt-4 mb-8 text-gray-500">
            强有力的工具强有力的工具强有力的工具 强有力的工具 强有力的工具
            强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具
            强有力的工具 强有力的工具 强有力的工具 强有力的工具 强有力的工具
            强有力的工具 强有力的工具 强有力的工具
          </p>
              ...
              >
                ...
                <div className="flex justify-between relative">
                  <p className="text-lg leading-7 mt-1">
                    构建简单的生态系统构建简单的生态系统 构建简单的生态系统
                    构建简单的生态系统 构建简单的生态系统 构建简单的生态系统
                    构建简单的生态系统 构建简单的生态系统 构建简单的生态系统
                    构建简单的生态系统 构建简单的生态系统
                  </p>
                  <svg
